...
class LanguageManager:
    ...
    def change_language(self, language_button, download_button_addon, download_button_patches,
        ...
        if self.current_language == "ge":
            ...
            download_button_addon.configure(text="ადონების გადმოწერა", width=150, height=45, font=("Arial", 20, 'bold'))
            download_button_patches.configure(text="პაჩების გადმოწერა", width=150, height=45, font=("Arial", 20, 'bold'))
